...
const io = new Server(server, {
    cors: {
        origin: process.env.FRONTEND_URL || 'http://51.20.117.228:3000', // Use environment variable for production URL
        methods: ['GET', 'POST'],
        credentials: true,
    },
});
...
app.use(cors({
    origin: process.env.FRONTEND_URL || 'http://51.20.117.228:3000', // Same origin as the frontend
    methods: ['GET', 'POST'],
    credentials: true,
}));
