...
const Signup = () => {
  ...
  const baseURL = import.meta.env.VITE_Base_url || "http://13.61.241.125:5000";  //to use .env in frontend (in vite) , import.meta.env is used, backend me process.env used
